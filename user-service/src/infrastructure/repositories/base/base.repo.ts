...
export abstract class BaseRepository<Entity, Persistence, DbMapper extends IDbMapper<Entity, Persistence>> implements IRead<Entity, Partial<Entity>>, IWrite<Entity  > { 
    ...
    async update(id: Pick<Entity, keyof Entity>, entity: Entity): Promise<Entity | null> {
        const persistence = this.mapper.toPersistence(entity);
